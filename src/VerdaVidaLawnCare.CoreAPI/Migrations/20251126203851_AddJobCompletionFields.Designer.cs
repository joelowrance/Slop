...
namespace VerdaVidaLawnCare.CoreAPI.Migrations
{
    ...
    [Migration("20251126203851_AddJobCompletionFields")]
    partial class AddJobCompletionFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VerdaVidaLawnCare.CoreAPI.Models.Customer", b =>
                {
                    ...
                    b.HasIndex("Address")
                        .HasDatabaseName("ix_customers_address");
            ...
            modelBuilder.Entity("VerdaVidaLawnCare.CoreAPI.Models.Estimate", b =>
                {
                    ...
                    b.HasIndex("CompletedDate")
                        .HasDatabaseName("ix_estimates_completed_date");
                    ...
                    b.HasIndex("ScheduledDate")
                        .HasDatabaseName("ix_estimates_scheduled_date");
